document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderAppointments() {
        ...
        if (currentCalendarView === 'agenda') {
            ...
            html += `<div class="weekly-calendar-wrapper">`;
            
            // Time Axis
            html += `<div class="weekly-time-axis">`;
            ...
            // Grid Container
            html += `<div class="weekly-grid-container">`;
            
            // Headers
            html += `<div class="weekly-days-header">`;
            ...
            // Grid Body
            html += `<div class="weekly-days-grid">`;
            ...
            html += `</div>`; // .weekly-grid-container
