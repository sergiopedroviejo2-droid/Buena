document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadDropdowns() {
        const treatments = await fetchApi('/api/treatments');
        const professionals = await fetchApi('/api/professionals');
        const rooms = await fetchApi('/api/rooms');
        console.log('Loaded dropdown data', { treatments, professionals, rooms });
